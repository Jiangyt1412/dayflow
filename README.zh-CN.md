...
<p align="center"><strong>版本 1.4.3</strong> · <a href="CHANGELOG.zh-CN.md">更新记录</a> · <a href="QA.md">验证报告</a></p>
...
**1.4.3 更新 · 2026 年 9 月 24 日：** Insights 增加页间距、稳定图表切换布局，支持从图表与卡片滑动；清理 Focus／Notes 留白，编辑弹窗隔离底层滚动。[查看更新详情](CHANGELOG.zh-CN.md)。

**1.4.2 更新 · 2026 年 9 月 24 日：** Insights 改为相邻页面同步移动，支持离线切换；应用栏目之间切换不再逐次增加返回记录。[查看更新详情](CHANGELOG.zh-CN.md)。
...
补录按一个连续专注时间段保存。修改已有开始时间或时长会替换原始片段并移除暂停，保存前会有提示；仅改分类、任务或笔记则保留原始时间。当前活动计时器不受影响。
...
**1.2.0 新增：** 在 **Insights → Notes** 写日记、记录心情和状态；**Focus** 提供四项累计、分类饼图、24 小时分布和逐日/全年逐月趋势。专注历史显示关联任务名称，删除任务仍保留记录；更新前已经删除且没有名称快照的任务无法恢复名称。
